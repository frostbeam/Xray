...
# Hosting
kenDevXD="raw.githubusercontent.com/kenDevXD/Xray/main"
cd /usr/bin
## Menu
wget -O menu "https://${kenDevXD}/Xray/menu/menu.sh"
wget -O vmess "https://${kenDevXD}/Xray/menu/vmess.sh"
wget -O vless "https://${kenDevXD}/Xray/menu/vless.sh"
wget -O trojan "https://${kenDevXD}/Xray/menu/trojan.sh"
wget -O shadowsocks "https://${kenDevXD}/Xray/menu/shadowsocks.sh"
wget -O shadowsocks2022 "https://${kenDevXD}/Xray/menu/shadowsocks2022.sh"
wget -O socks "https://${kenDevXD}/Xray/menu/socks.sh"
## Vmess
wget -O add-vmess "https://${kenDevXD}/Xray/vmess/add-vmess.sh"
wget -O del-vmess "https://${kenDevXD}/Xray/vmess/del-vmess.sh"
wget -O extend-vmess "https://${kenDevXD}/Xray/vmess/extend-vmess.sh"
wget -O trialvmess "https://${kenDevXD}/Xray/vmess/trialvmess.sh"
wget -O cek-vmess "https://${kenDevXD}/Xray/vmess/cek-vmess.sh"
## Vless
wget -O add-vless "https://${kenDevXD}/Xray/vless/add-vless.sh"
wget -O del-vless "https://${kenDevXD}/Xray/vless/del-vless.sh"
wget -O extend-vless "https://${kenDevXD}/Xray/vless/extend-vless.sh"
wget -O trialvless "https://${kenDevXD}/Xray/vless/trialvless.sh"
wget -O cek-vless "https://${kenDevXD}/Xray/vless/cek-vless.sh"
## Trojan
wget -O add-trojan "https://${kenDevXD}/Xray/trojan/add-trojan.sh"
wget -O del-trojan "https://${kenDevXD}/Xray/trojan/del-trojan.sh"
wget -O extend-trojan "https://${kenDevXD}/Xray/trojan/extend-trojan.sh"
wget -O trialtrojan "https://${kenDevXD}/Xray/trojan/trialtrojan.sh"
wget -O cek-trojan "https://${kenDevXD}/Xray/trojan/cek-trojan.sh"
## Shadowsocks
wget -O add-ss "https://${kenDevXD}/Xray/shadowsocks/add-ss.sh"
wget -O del-ss "https://${kenDevXD}/Xray/shadowsocks/del-ss.sh"
wget -O extend-ss "https://${kenDevXD}/Xray/shadowsocks/extend-ss.sh"
wget -O trialss "https://${kenDevXD}/Xray/shadowsocks/trialss.sh"
wget -O cek-ss "https://${kenDevXD}/Xray/shadowsocks/cek-ss.sh"
## Shadowsocks 2022
wget -O add-ss2022 "https://${kenDevXD}/Xray/shadowsocks2022/add-ss2022.sh"
wget -O del-ss2022 "https://${kenDevXD}/Xray/shadowsocks2022/del-ss2022.sh"
wget -O extend-ss2022 "https://${kenDevXD}/Xray/shadowsocks2022/extend-ss2022.sh"
wget -O trialss2022 "https://${kenDevXD}/Xray/shadowsocks2022/trialss2022.sh"
wget -O cek-ss2022 "https://${kenDevXD}/Xray/shadowsocks2022/cek-ss2022.sh"
## Socks5
wget -O add-socks "https://${kenDevXD}/Xray/socks/add-socks.sh"
wget -O del-socks "https://${kenDevXD}/Xray/socks/del-socks.sh"
wget -O extend-socks "https://${kenDevXD}/Xray/socks/extend-socks.sh"
wget -O trialsocks "https://${kenDevXD}/Xray/socks/trialsocks.sh"
wget -O cek-socks "https://${kenDevXD}/Xray/socks/cek-socks.sh"
## Log
wget -O log-create "https://${kenDevXD}/Xray/log/log-create.sh"
wget -O log-vmess "https://${kenDevXD}/Xray/log/log-vmess.sh"
wget -O log-vless "https://${kenDevXD}/Xray/log/log-vless.sh"
wget -O log-trojan "https://${kenDevXD}/Xray/log/log-trojan.sh"
wget -O log-ss "https://${kenDevXD}/Xray/log/log-ss.sh"
wget -O log-ss2022 "https://${kenDevXD}/Xray/log/log-ss2022.sh"
wget -O log-socks "https://${kenDevXD}/Xray/log/log-socks.sh"
## Other
wget -O xp "https://${kenDevXD}/Xray/other/xp.sh"
wget -O dns "https://${kenDevXD}/Xray/other/dns.sh"
wget -O certXray "https://${kenDevXD}/Xray/other/certXray.sh"
wget -O Xraymod "https://${kenDevXD}/Xray/other/Xraymod.sh"
wget -O Xrayofficial "https://${kenDevXD}/Xray/other/Xrayofficial.sh"
wget -O about "https://${kenDevXD}/Xray/other/about.sh"
## Chmod Vmess
chmod +x add-vmess
chmod +x del-vmess
...
echo ""
echo -e "${BB}—————————————————————————————————————————————————————————${NC}"
echo -e "               ${WB}V2-RAYPLUS BY AIXXY7.COM${NC}"
echo -e "${BB}—————————————————————————————————————————————————————————${NC}"
